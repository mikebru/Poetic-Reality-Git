...
public class AudioSpectrumWebGL : MonoBehaviour
{
    ...
    void CheckBuffers ()
    {
        if (rawSpectrum == null || rawSpectrum.Length != amplitude.sampleSize) {
            rawSpectrum = new float[amplitude.sampleSize];
        }
